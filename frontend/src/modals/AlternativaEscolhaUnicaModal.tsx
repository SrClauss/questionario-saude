...
interface EscolhaUnicaModalProps {
    open: boolean;
    onClose: () => void;
    onSave: (data: EscolhaUnicaData) => void;
    initialData?: EscolhaUnicaData;
}

const EscolhaUnicaModal: React.FC<EscolhaUnicaModalProps> = ({ 
    open, 
    onClose, 
    onSave, 
    initialData 
...
export default EscolhaUnicaModal;
 ...
 const ProfissionalSaudeModal: React.FC<ProfissionalSaudeModalProps> = ({ open, onClose, profissionalSaude, mode = 'create', onSubmit }) => {
     ...
     const handleSubmit = async () => {
         ...
         try {
             ...
             const url = mode === 'create' ? `${baseUrl}/profissionais_saude/register` : `${baseUrl}/profissionais_saude/${profissionalSaude?.id}`;
     ...
     return (
         <Modal open={open} onClose={onClose}>
             ...
             >
                 ...
                 >
                     <Typography variant="h6">{(mode === 'create' ? 'Criar' : 'Editar') + ' Profissional de Saúde'}</Typography>
                     <Box
                         sx={{
                             cursor: 'pointer',
                 ...
                 <ColumnResponsive>
                     <TextField
                         ...
                         onChange={(e) => dispatch({ type: 'SET_REGISTRO_PROFISSIONAL', payload: e.target.value })}
                         fullWidth
                         margin="normal"
                     />
                     <TextField
                 ...
                 <ColumnResponsive>
                     <TextField
                         ...
                         onChange={(e) => dispatch({ type: 'SET_TIPO_REGISTRO', payload: e.target.value })}
                         fullWidth
                         margin="normal"
                     />
                     <TextField
                         ...
                         onChange={(e) => dispatch({ type: 'SET_ESTADO_REGISTRO', payload: e.target.value })}
                         fullWidth
                         margin="normal"
                     />
                 </ColumnResponsive>

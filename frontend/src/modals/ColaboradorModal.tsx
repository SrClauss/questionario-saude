...
const ColaboradorModal: React.FC<ColaboradorModalProps> = ({ open, onClose, colaborador, mode = 'create', onSubmit }) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const url = mode === 'create' ? `${baseUrl}/colaboradores/register` : `${baseUrl}/colaboradores/${colaborador?.id}`;
    ...
    return (
        <Modal open={open} onClose={onClose}>
            ...
            >
                ...
                >
                    <Typography variant="h6">{(mode === 'create' ? 'Criar' : 'Editar') + ' Colaborador'}</Typography>
                    <Box
                        sx={{
                            cursor: 'pointer',
